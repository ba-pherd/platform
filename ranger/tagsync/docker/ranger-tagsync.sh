...
then
  ...
  then
    ...
    wget -O "${RANGER_HOME}/ranger-${TAGSYNC_VERSION}-tagsync/lib/guava-25.1-jre.jar" https://repo1.maven.org/maven2/com/google/guava/guava/25.1-jre/guava-25.1-jre.jar
    chmod 755 "${RANGER_HOME}/ranger-${TAGSYNC_VERSION}-tagsync/lib/guava-25.1-jre.jar"
  else
